...
// WiFi
#define WIFI_SSID "TP-LINK_3C8222"
#define WIFI_PASSWORD "BENKEDAFA"

// Firebase
#define API_KEY "AIzaSyAnFWBpKFttjGF9-EfL3sd3L2_aFVw_EjE"
#define DATABASE_URL "https://smartshelf-for-smartshop-default-rtdb.firebaseio.com/"
...
// الوزن
float calibration_factor = 114975;
...
// استخدام Median بدل المتوسط العادي
scale.set_median_mode();

delay(3000);

  shelfWeight = readStableWeight();
...
static unsigned long weightFirebaseTimer = 0;

if (millis() - weightFirebaseTimer >= 1000) {

  weightFirebaseTimer = millis();
